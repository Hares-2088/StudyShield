<template>
  <div class="bg-white/70 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-md w-full animate-fadeIn center mx-auto mt-20">
    ...
    <form @submit.prevent="handleLogin" class="space-y-6">
      ...
      <div>
        ...
        <div class="mt-1 relative">
          <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-pink-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c1.105 0 2 .895 2 2v2H10v-2c0-1.105.895-2 2-2z" />
      ...
      <p v-if="error" class="text-center text-sm text-red-500 mt-2 flex items-center justify-center">
        <svg class="h-4 w-4 mr-1 text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
