        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="bg-white shadow-lg rounded-xl p-8 md:col-span-1">
            ...
            <div class="space-y-3">
              ...
              <p class="text-gray-700"><span class="font-semibold">Longest Streak:</span> {{ user?.longestStreak }} days</p>
            </div>
          </div>
          ...
          <div class="bg-white shadow-lg rounded-xl p-8 md:col-span-1">
            ...
            <ul class="space-y-2 max-h-72 overflow-auto">
              <li v-for="item in purchasedItems" :key="item.id" class="flex justify-between items-center bg-gray-100 rounded-lg px-4 py-2">
          ...
          <div class="bg-white shadow-lg rounded-xl p-8 md:col-span-1">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div v-for="milestone in milestones" :key="milestone.milestoneId" class="bg-[#f0e6ef] rounded-xl shadow-md p-4 text-center">
                <span class="text-3xl font-bold text-[#4a4e69]">{{ milestone.progress }}</span>
                <p class="text-sm text-gray-600 capitalize mt-1">{{ milestone.currentTier }}</p>
              </div>
            </div>
          </div>
        </div>
