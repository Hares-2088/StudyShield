...
<template>
    <div
        class="bg-gradient-to-br from-[#cdb4db] via-[#ffc8dd] to-[#a2d2ff] opacity-90 animate-gradient p-4 md:p-6 rounded-lg shadow-md mb-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input id="taskName" v-model="taskName" type="text" placeholder="What are you working on?"
                    class="w-full p-2 border border-[#ffc8dd] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffafcc] text-gray-900"
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    <button @click="setTaskTime(15)"
                        class="bg-white px-4 py-2 rounded-lg hover:bg-[#a2d2ff] transition-colors text-gray-900">
                        15
                    </button>
                ...
                <input id="taskTime" v-model.number="taskTime" type="number" placeholder="Custom time"
                    class="w-full mt-2 p-2 border border-[#ffc8dd] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffafcc] text-gray-900"
                    min="5" step="5" />
            </div>
            <button @click="submitTask"
                class="bg-white px-4 py-2 rounded-lg hover:bg-[#a2d2ff] transition-colors w-full text-gray-900"
